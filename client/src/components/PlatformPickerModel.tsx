        ...
        <div className="p-6 flex flex-col gap-2">
            {PLATFORMS.map((p)=> {
                ...
                return (
                    ...
                    className={`flex items-center gap-3 p-3.5 rounded-xl border text-left transition-all ${isConnected? "border-red-200 bg-red-50 cursor-default" : "border-slate-200 hover:border-slate-300 hover:bg-slate-100 cursor-pointer"} ${isConnecting ? "opacity-60" : ""}`}>
                        {/* Icon */}
                        <div className="p-2">
